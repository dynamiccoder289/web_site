...
export const WHATSAPP_MESSAGES = {
  AUDIT: "Hello can you share a checklist for audit & assurance services",
  TAX: "Hello can you share a checklist for Taxation & Regulatory services",
  ADVISORY:
    "Hello can you share a checklist for Business Advisory consultation",
};
