export const EXPERIENCE_STATS = [
  ...
  },
  {
    ...
    description: "Comprehensive financial reviews",
  },
];
...
export const INDUSTRIES = [
  ...
  },
  {
    ...
    clients: "40+",
    description:
      "Hospitals, clinics, diagnostic centers, and pharma distributors",
...
export const MILESTONES = [
  {
    year: "2008",
    event: "Somasekhara & Associates founded with vision for excellence",
    highlight: true,
  },
  { year: "2010", event: "Crossed 100 client milestone - Rapid growth phase" },
  {
    year: "2012",
    event: "Expanded services with strategic partnership additions",
  },
  {
    year: "2015",
    event: "Launched dedicated GST practice - Market leadership",
  },
  {
    year: "2018",
    event: "Introduced comprehensive business advisory services",
  },
  {
    year: "2020",
    event: "Enhanced digital infrastructure for remote services",
  },
  { year: "2022", event: "Achieved 50+ client trust milestone" },
  {
    year: "2024",
    event: "Celebrating 1+ years of financial excellence",
    highlight: true,
  },
];
...
export const TESTIMONIALS = [
  {
    text: "Somasekhara & Associates has been our trusted accounting partner for 8 years. Their proactive tax planning has consistently saved us significant amounts while ensuring 100% compliance.",
    client: "Rajesh Kumar",
...
export const EXPERIENCE_HERO_STATS = [
  { value: "5+", label: "Years Experience" },
  { value: "50+", label: "Happy Clients" },
  { value: "50+", label: "Industry Segments" },
];
