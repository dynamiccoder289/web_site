...
import {
  ...
  VALUES_HERO_STATS,
  VALUES_LIVING_STATS,
} from "../constants/ourValuesConstants";
...
export default function OurValues() {
  ...
  const coreValues = CORE_VALUES.map((v, i) => ({
    ...v,
    icon: VALUE_ICONS[i],
  }));
  const valuePillars = VALUE_PILLARS.map((p, i) => ({
    ...p,
    icon: PILLAR_ICONS[i],
  }));
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
              The unwavering principles that define our culture, guide our
              decisions, and shape every interaction with our clients
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gray-900">
              The Principles That{" "}
              <span className="text-[var(--color-primary)]">Drive Us</span>
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto text-lg leading-relaxed">
              These six core values are embedded in our DNA. They influence how
              we hire, how we work, and how we measure success.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                More Than{" "}
                <span className="text-[var(--color-primary)]">Words</span> on a
                Page
              </h2>
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p>
                  At Somasekhara & Associates, our values are not just corporate
                  statements—they are living principles that shape our daily
                  operations, decision-making processes, and client
                  relationships.
                </p>
                <p>
                  We have built a culture where these values are celebrated,
                  measured, and reinforced through our performance systems,
                  training programs, and recognition initiatives.
                </p>
                <p>
                  Every team member undergoes comprehensive value-based
                  training, and our leadership team regularly reviews how well
                  we're living up to these principles in our service delivery.
                </p>
              </div>
