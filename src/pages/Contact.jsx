      ...
      <section className="py-10 md:py-12 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-dark)] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="tel:+919533680345" className="bg-white text-[var(--color-primary)] font-semibold px-6 py-2.5 rounded-lg hover:bg-gray-50 transition-colors text-sm">
              Call: +91 95336 80345
            </a>
            <a href="mailto:naiduakula09@gmail.com" className="border border-white/30 text-white font-semibold px-6 py-2.5 rounded-lg hover:bg-white/10 transition-colors text-sm">
              Email Us Now
            </a>
          </div>
        </div>
